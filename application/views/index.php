...
<div id="site-content" class="site-content">
              ...
              <div class="wpb_column vc_column_container vc_col-sm-12">
                        ...
                        <rs-slides>
                          <rs-slide data-key="rs-3" data-title="Slide" data-thumb="" data-anim="ei:d,d;eo:d,d;s:d,d;r:0,0;t:fadetorightfadefromleft,fadefromleft;sl:d,d;" data-sloop="s:2500;e:4500;">
                            ...
                            <rs-layer
                              ...
                              ><div class="slider-sub">Watch Your</div> 
                            </rs-layer>
                            <rs-layer
                            ...
                            ><div class="slider-title">Event's <span class="" style="color: #ef9bbd;">Success</span></div> 
                            </rs-layer>
                            <rs-layer
                            ...
                            ><div class="slider-title">Unfold</div> 
                            </rs-layer>
                            <rs-layer
                ...
                <!--
                            ...
                            <rs-layer
                                ...
                                data-type="text"
                                data-color="#ffffff"
                                data-xy="x:r;xo:834px;y:c;yo:120px;"
                                data-text="s:112;l:128;fw:600;a:inherit;"
                                data-frame_0="y:-100%;o:1;tp:600;"
                                data-frame_0_mask="u:t;"
                                data-frame_1="tp:600;sp:1500;sR:10;"
  ...
  <!-- /#site-footer -->
    ...
    <!-- END JUMBOTRON -->
      ...
      <!-- BEGIN NETWORK SOLUTIONS SECTION -->
      <section class="bg-master-lightest p-b-85 p-t-75" id="our-team">
        <div class="container">
                ...
                <div class="card d-flex m-auto mb-2" data-aos="fade-right">
                  ...
                  <div class="card-body">
                    ...
                    <ul class="pl-3">
                      ...
                      <li>E-gifts and other Simultaneous Logistics <br> Services</li>
                    </ul>
                  </div>
                </div>
              ...
              <div class="col-xs-height col-middle">
                <div class="text-center" data-aos="fade-up">
                  ...
                  <p class="text-white m-t-30 m-b-30"> For only three years after its inception (12 Years now), Full Circle has established a niche in the Information Technology 
                    and the Corporate Industry and has become one of the top of mind events agencies that cater not only to the IT but also in other fields. </p> 
        ...
        <div class="md-p-l-20 xs-no-padding clearfix">
          <div class="col-sm-12 col-md-12">
            ...
            <div class="row height-155px">
              ...
              <div class="col-lg-2 col-4"><img src="<?php echo base_url('assets/image/clients/creative_tech.png'); ?>" class="img-thumbnail border-0" alt=""></div>
            ...
            <div class="row height-155px">
              ...
              <div class="col-lg-2 col-4"><img src="<?php echo base_url('assets/image/clients/jump.png'); ?>" class="img-thumbnail border-0" alt=""></div>
