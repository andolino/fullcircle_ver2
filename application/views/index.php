      ...
      <div class="container relative">
        ...
        <div class="pull-left">
          ...
          <div class="header-inner pt-2">
            <!-- BEGIN LOGO -->
            <a class="page-scroll" href="#page-top" class="active">
              <img src="assets/image/logo.png" width="120" height="" data-src-retina="assets/image/logo.png" class="logo" alt="">
              <img src="<?php echo base_url(); ?>assets/image/logo_landscape.png" width="200" data-src-retina="<?php echo base_url(); ?>assets/image/logo_landscape.png" class="alt mt-2" alt="">
            </a>
          </div>
        </div>
